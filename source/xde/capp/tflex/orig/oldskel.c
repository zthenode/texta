 ...
 * 1/3/1998
 *
 * created from skel.tpl and flex.skl
 */
...
const char *skel[]
 = {"%x Extended skeleton",
    ...
    "",
    "%+",
    "yyIsLexer::yyIsLexer( Stream* arg_yyin, Stream* arg_yyout )",
    "	{",
    "	yy_initialize();",
    "	yyin = arg_yyin;",
    "	yyout = arg_yyout;",
    ...
    "#endif",
    "%+",
    "void *yyIsLexer::yy_save_scan_state( Stream *input_file )",
    "%*",
    "	{",
    ...
    "	yy_switch_to_buffer((YY_BUFFER_STATE)old_state);",
    ...
    "#endif",
    "%+",
    "void yyIsLexer::yy_switch_streams( Stream* new_in, Stream* new_out )",
    "%*",
    "	{",
    "	if ( new_in )",
    "		{",
    ...
    "#endif",
    "%+",
    "void yyIsLexer::yyrestart( Stream* input_file )",
    "%*",
    "	{",
    "	if ( ! yy_current_buffer )",
    "		yy_current_buffer = yy_create_buffer( yyin, YY_BUF_SIZE );",
    ...
    "#endif",
    "%+",
    "YY_BUFFER_STATE yyIsLexer::yy_create_buffer( Stream* file, int size )",
    "%*",
    "	{",
    "	YY_BUFFER_STATE b;",
    "",
    ...
    "void yyIsLexer::yy_init_buffer( YY_BUFFER_STATE b, Stream* file )",
    "%*",
    "",
    "	{",
    "	yy_flush_buffer( b );",
