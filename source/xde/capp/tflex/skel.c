 ...
 * file: skel.c
 *
 * Generated from file flex.skl and template skel.t
 *
 * date: 1/2/2002
 * time: 
 */
...
={"%x Extended skeleton",
  ...
  "",
  "#define YY_INITIALIZE",
  "#define YY_FINISH",
  "#define YY_RESET",
  "#define YY_SAVE_SCAN_STATE",
  "#define YY_RESTORE_SCAN_STATE",
  "#define YY_SWITCH_STREAMS",
  "",
  "%y_initalize",
  "%y_finish",
  "%y_reset",
  "%y_save_scan_state",
  "%y_restore_scan_state",
  "%y_switch_streams",
  "",
  "void yy_initalize YY_PROTO(( void ));",
  "void yy_finish YY_PROTO(( void ));",
  "void yy_reset YY_PROTO(( void ));",
  "void *yy_save_scan_state YY_PROTO(( FILE *input_file ));",
  "void yy_restore_scan_state YY_PROTO(( void *old_scan ));",
  "void yy_switch_streams YY_PROTO(( FILE *new_in, FILE *new_out ));",
  "",
  ...
  "",
  "%- Standard (non-C++) definition",
  "/* make sure yylineno is defined even if not \"%option yylineno\" */",
  ...
  "    }",
  "",
  "yyIsLexer::yyIsLexer( cStream* arg_yyin, cStream* arg_yyout )",
  "    {",
  "    yy_initialize();",
  "    yyin = arg_yyin;",
  "    yyout = arg_yyout;",
  ...
  "    int count;",
  "",
  "    if ((error=yyin->Read(count, buf, max_size )))",
  "        return 0;",
  "",
  "    return count;",
  "#endif",
  ...
  "%-",
  "#ifdef YY_USE_PROTOS",
  "void *yy_save_scan_state( FILE *input_file )",
  "#else",
  "void *yy_save_scan_state( input_file )",
  "FILE *input_file;",
  "#endif",
  "%+",
  "void *yyIsLexer::yy_save_scan_state( cStream *input_file )",
  "%*",
  "    {",
  ...
  "#else",
  "void yy_restore_scan_state( old_state )",
  "void *old_state;",
  "#endif",
  "%+",
  ...
  "%-",
  "#ifdef YY_USE_PROTOS",
  "void yy_switch_streams( FILE *new_in, FILE *new_out )",
  "#else",
  "void yy_switch_streams( new_in, new_out )",
  "FILE *new_in, *new_out;",
  "#endif",
  "%+",
  "void yyIsLexer::yy_switch_streams( cStream* new_in, cStream* new_out )",
  "%*",
  "    {",
  "    if ( new_in )",
  "        {",
  ...
  "#endif",
  "%+",
  "void yyIsLexer::yyrestart( cStream* input_file )",
  "%*",
  "    {",
  "    if ( ! yy_current_buffer )",
  "        yy_current_buffer = yy_create_buffer( yyin, YY_BUF_SIZE );",
  ...
  "#endif",
  "%+",
  "YY_BUFFER_STATE yyIsLexer::yy_create_buffer( cStream* file, int size )",
  "%*",
  "    {",
  "    YY_BUFFER_STATE b;",
  "",
  ...
  "void yyIsLexer::yy_init_buffer( YY_BUFFER_STATE b, cStream* file )",
  "%*",
  "",
  "    {",
  "    yy_flush_buffer( b );",
