...
#endif /* !defined(NO_ANSI_C)  */
{
    ...
    {
	line[i]  =  c;
	if (c == '\n') { cptr = line; return NO_ANSI_C_DEFAULT_RESULT; }
	if (++i >= linesize)
	{
	    linesize += LINESIZE;
...
#endif /* !defined(NO_ANSI_C)  */
{
    ...
    if (tag_table == 0) return NO_ANSI_C_DEFAULT_RESULT;
...
#endif /* !defined(NO_ANSI_C)  */
{
    ...
    if (!vflag) return NO_ANSI_C_DEFAULT_RESULT;
