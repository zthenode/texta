...
public:
    ...
    //     Date: 6/4/2007
    ///////////////////////////////////////////////////////////////////////
    virtual EvcpServletContext* 
    GetParentContext(EvError& error) const
    {
        EvcpServletContext* parentContext = 0;
        EvcpServlet* parent;

        if ((parent = GetParentEvcpServlet(error)))
            parentContext = parent->GetEvcpServletContext(error);
        else DBE("() failed to get parent context\n");
