...
public:
     ...
     bool isLocal=false) const
    {
        ...
        fileTime.SetYear(systemTime.tm_year+1900);
        fileTime.SetMonth(systemTime.tm_mon+1);
        fileTime.SetDay(systemTime.tm_mday);
        fileTime.SetHour(systemTime.tm_hour);
        fileTime.SetMinute(systemTime.tm_min);
        fileTime.SetSecond(systemTime.tm_sec);
